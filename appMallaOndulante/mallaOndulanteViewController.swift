//
//  mallaOndulanteViewController.swift
//  appMallaOndulante
//
...
class mallaOndulanteViewController: UIViewController {
   ...
   func sinFunction(x: Float, z: Float) -> Float {
       ...
       func dibujaMalla() {
           ...
           // Crear la esfera
              ...
              //    sphereNode.position = SCNVector3(x: 0, y: 5, z: 0)
              //    sphere.firstMaterial?.diffuse.contents = UIColor.red
               //   scene.rootNode.addChildNode(sphereNode)

                  // Agregar acción de rebote a la esfera
               //   let moveUp = SCNAction.moveBy(x: 0, y: 15, z: 0, duration: 1.0)
              //    let moveDown = SCNAction.moveBy(x: 0, y: -15, z: 0, duration: 1.0)
